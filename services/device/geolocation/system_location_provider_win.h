...
#ifndef SERVICES_DEVICE_GEOLOCATION_SYSTEM_LOCATION_PROVIDER_WIN_H_
#define SERVICES_DEVICE_GEOLOCATION_SYSTEM_LOCATION_PROVIDER_WIN_H_

#include "base/single_thread_task_runner.h"
#include "base/win/scoped_com_initializer.h"
#include "system_location_provider.h"
#include <windows.h>
#include <atlbase.h>
#include <atlcom.h>
...
// workaround for "duplicate symbol" lld-link error
class MyCComObjectThreadModel : public CComObjectThreadModel {
};
#define MY_CCOM_OBJECT_ROOT CComObjectRootEx<MyCComObjectThreadModel>
#else
#define MY_CCOM_OBJECT_ROOT CComObjectRoot
#endif

class SystemLocationDataProviderWin :
  public MY_CCOM_OBJECT_ROOT,
...
#endif  // SERVICES_DEVICE_GEOLOCATION_SYSTEM_LOCATION_PROVIDER_WIN_H_
