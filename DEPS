...
deps = {
  ...
  'src/third_party/ffmpeg':
    'https://github.com/jtg-gg/nwjs-ffmpeg.git@origin/dev16-m52',
  ...
  'src/third_party/skia':
    'https://github.com/jtg-gg/skia.git@origin/dev16-m52',
  ...
  'src/v8':
    (Var("nwjs_git")) + '/v8.git@origin/nw16',
  'src/content/nw':
    'https://github.com/jtg-gg/node-webkit.git@origin/dev16-m52',
  'src/third_party/node':
    (Var("nwjs_git")) + '/node.git@origin/nw16',
}
